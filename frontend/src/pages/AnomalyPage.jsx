...
export default function AnomalyPage() {
  ...
  return (
    <div>
      <h2 className="mb-4"><i className="fa-solid fa-brain me-2" />Anomaly IDS Dashboard</h2>
      ...
      <AlertsTable alerts={data.alerts} title="Anomaly Alerts" showExplain />
    </div>
  );
}
